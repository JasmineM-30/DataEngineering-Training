...
INSERT INTO employees (empt_id, first_name, last_name, age, dept_id, salary) VALUES
...
SELECT e.empt_id, e.first_name, e.last_name,d.dept_name, d.location 
