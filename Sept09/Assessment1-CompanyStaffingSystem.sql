...
SELECT * FROM staff; -- part A Basic Staff Queries
...
SELECT COUNT(*) AS total_no_staff FROM staff;


SELECT * FROM departments; -- part B Basic Department Queries
...
SELECT s.first_name, s.last_name, d.dept_name -- part C INNER JOIN
FROM staff s
...
SELECT s.first_name, s.last_name, d.dept_name -- part D LEFT JOIN
FROM staff s
...
SELECT s.first_name, s.last_name, d.dept_name -- part E RIGHT JOIN
FROM staff s
